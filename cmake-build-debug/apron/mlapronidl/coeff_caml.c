...
/* This file is part of the APRON Library, released under LGPL license  with an exception allowing the redistribution of statically linked executables.
  Please read the COPYING file packaged in the distribution  *//* File generated from coeff.idl */
...
value camlidl_c2ml_coeff_struct_ap_coeff_t(struct ap_coeff_t * _c1, camlidl_ctx _ctx)
{
  ...
  case Interval:
    ...
    break;
  default:
    caml_invalid_argument("struct ap_coeff_t: bad discriminant for union ");
  }
  return _v2;
}
