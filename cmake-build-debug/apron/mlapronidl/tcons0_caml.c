...
/* This file is part of the APRON Library, released under LGPL license  with an exception allowing the redistribution of statically linked executables.
  Please read the COPYING file packaged in the distribution  *//* File generated from tcons0.idl */
...
void camlidl_ml2c_tcons0_struct_ap_tcons0_array_t(value _v1, struct ap_tcons0_array_t * _c2, camlidl_ctx _ctx)
{
  mlsize_t _c3;
  mlsize_t _c4;
  value _v5;
  _c3 = Wosize_val(_v1);
  (*_c2).p = camlidl_malloc(_c3 * sizeof(ap_tcons0_t ), _ctx);
  for (_c4 = 0; _c4 < _c3; _c4++) {
    _v5 = Field(_v1, _c4);
    camlidl_ml2c_tcons0_ap_tcons0_t(_v5, &(*_c2).p[_c4], _ctx);
  }
  (*_c2).size = _c3;
}

value camlidl_c2ml_tcons0_struct_ap_tcons0_array_t(struct ap_tcons0_array_t * _c1, camlidl_ctx _ctx)
{
  value _v2;
  mlsize_t _c3;
  value _v4;
  ...
  Begin_root(_v2)
    for (_c3 = 0; _c3 < (*_c1).size; _c3++) {
      _v4 = camlidl_c2ml_tcons0_ap_tcons0_t(&(*_c1).p[_c3], _ctx);
      caml_modify(&Field(_v2, _c3), _v4);
    }
  End_roots()
  return _v2;
}
